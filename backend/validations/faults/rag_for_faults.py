...
def get_common_faults(pump_model: str) -> str:
    """
    Given a pump model, returns a short, professional engineering summary of common faults
    using the Elected_Operating_Problems_of_Central_Pu.pdf as context.
    """
    pdf_path = "Elected_Operating_Problems_of_Central_Pu.pdf"
    ...
    query = f"What are the most common faults or operating problems for the pump model: {pump_model}? Provide a short, professional engineering summary."
    results = []
    try:
