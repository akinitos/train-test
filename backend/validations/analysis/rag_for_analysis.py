...
def _generate_summary_and_findings(
    ...
    prompt = (
        ...
        "written as a senior reliability engineer advising on maintenance strategy; "
        "do NOT reference chunk or section numbers),\n"
        '  "key_findings": a JSON array of 3-5 short key engineering findings about maintenance.\n\n'
        "Example:\n"
...
def get_maintenance_approach(pump_model: str) -> str:
    ...
    validation = {
        "summary": f"RAG validation for maintenance approach of pump model '{pump_model}' is temporarily disabled due to embedding API unavailability. The agent's analysis is provided without PDF-backed validation.",
        "confidence": 0.0,
